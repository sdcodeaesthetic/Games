var player1 = prompt("Player One: Enter Your Name, You Will Have Blue!");
var player1Color = "rgb(24, 113, 173)";

var player2 = prompt("Player Two: Enter Your Name, You Will Have Red!");
var player2Color = "rgb(237, 21, 21)";
...
function diagonalWinCheck() {
  for (var col = 0; col < 5; col++) {
    for (var row = 0; row < 7; row++) {
      ...
      else if (colorMatchCheck(returnColor(row, col), returnColor(row-1, col+1), returnColor(row-2, col+2), returnColor(row-3, col+3)) === true) {
        console.log("Diagonal");
        reportWin(row, col);
        return true;
      }
